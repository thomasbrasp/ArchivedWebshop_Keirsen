...
products.forEach((product) => {
  ...
  const productLink = addElement('a', null, null, `${product.href}`);
...
function renderShoppingCart() {
  ...
  shoppingCart.forEach((cartItem) => {
    ...
    //create cartItem
    const shoppingCartItem = addElement('div', 'shopping-cart-item-container');
  ...
  const shoppingCartTotal = addElement('div', 'shopping-cart-total');
